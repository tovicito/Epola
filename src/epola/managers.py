            ...
            for line in res.stdout.split('\n'):
                if line.startswith('Inst '):
                    ...
                    updates.append({
                        ...
                        'name': pkg_name,
                        'manager': 'apt',
                        'description': _('Update available')
                    })
            return updates
        except:
            return []
            ...
            for line in res.stdout.strip().split('\n'):
                ...
                if len(parts) >= 2:
                    updates.append({
                        ...
                        'name': parts[1].strip(),
                        'manager': 'flatpak',
                        'description': _('Update available (Flatpak)')
                    })
            return updates
        except:
            return []
                ...
                for line in lines[1:]:
                    ...
                    if len(parts) >= 1:
                        updates.append({
                            ...
                            'name': parts[0],
                            'manager': 'snap',
                            'description': _('Update available (Snap)')
                        })
            return updates
        except:
            return []
        ...
        try:
            ...
            for line in res.stdout.strip().split('\n'):
                ...
                if len(parts) >= 1 and '.' in parts[0]:
                    ...
                    updates.append({'id': pkg_name, 'name': pkg_name, 'manager': 'dnf', 'description': _('Update available')})
            return updates
        except: return []
        ...
        try:
            ...
            for line in res.stdout.strip().split('\n'):
                if line:
                    ...
                    updates.append({'id': pkg_name, 'name': pkg_name, 'manager': 'pacman', 'description': _('Update available')})
            return updates
        except: return []
